...
<section id="about" class="padded layout row">
    <div class="padded flex md6 flex-center">
        <div>
    ...
    <div class="padded flex md6">
        <img src="storage/defaults/logo-black.png" alt="Route Your Tour" width="100%">
    </div> 
</section>
...
<section id="bands" class="layout row">
    <div class="flex md6 flex-center">
...
<div class="relative neg-top" style="margin-left: 30px;">
    <v-btn large raised href="/venues" class="green darken-1 white--text">Take a look at all of our venues.</v-btn>
</div>

<section id="video-cta" class="layout row">
    <div class="padded flex md6 flex-center">
        <div>
...
<div class="text-xs-right relative neg-top" style="margin-right: 30px;">
    <v-btn large raised href="/register" class="blue darken-1 white--text">Seen enough? Sign up for a free account.</v-btn>
</div>
